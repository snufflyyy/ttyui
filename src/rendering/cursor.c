...
inline void ttyui_cursor_set_position(int x, int y) {
...
inline void ttyui_cursor_move_up(int times) {
    wprintf(L"\033[%dA", times);
}

inline void ttyui_cursor_move_down(int times) {
    wprintf(L"\033[%dB", times);
}

inline void ttyui_cursor_move_left(int times) {
    wprintf(L"\033[%dD", times);
}

inline void ttyui_cursor_move_right(int times) {
    wprintf(L"\033[%dC", times);
}

inline void ttyui_cursor_save_position() {
    wprintf(L"\033[s");
}

inline void ttyui_cursor_restore_position() {
    wprintf(L"\033[u");
}
